...
// Routes
const routes = {
  publish: "assignment3/build/**/*",
  server: "assignment3/build/",
  del: ["assignment3/build", ".publish"],
  img: {
    watch: "assignment3/src/img/**/*.{jpg,png,gif,bmp,webp,svg,ai}",
    src: "assignment3/src/img/*.{jpg,png,gif,bmp,webp,svg,ai}",
    dest: "assignment3/build/img/",
  },
  scss: {
    watch: "assignment3/src/scss/**/*.scss",
    src: "assignment3/src/scss/style.scss",
    dest: "assignment3/build/css/",
  },
  pug: {
    watch: "assignment3/src/**/*.pug",
    src: "assignment3/src/index.pug",
    dest: "assignment3/build/",
  },
};
